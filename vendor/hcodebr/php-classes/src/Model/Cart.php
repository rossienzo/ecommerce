...
class Cart extends Model {
	...
	public function addProduct(Product $product)
	{
		...
		//Atualiza o cep toda vez que adiciona o produto
	...
	public function removeProduct(Product $product, $all = false)
	{
		...
		//Atualiza o cep toda vez que remove o produto
		$this->getCalculateTotal();
	}
	...
	public function getProducts()
	{
		...
		$rows = $sql->select("
			...
			GROUP BY b.idproduct, b.desproduct, b.vlwidth, b.vlheight, b.vllength, b.vlweight, b.desurl 
