...
$app->get("/checkout", function(){
	...
	if (isset($_GET['zipcode'])) {
		...
		$address->loadFromCEP($_GET['zipcode']); //objeto carregado no endereço
...
/////INÍCIO DA ROTA REGISTRO DE USER/////
...
$app->post("/forgot", function(){
	...
	$user = User::getForgot($_POST["email"], false); // o false indica que não está mais na administração
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,80";
...
$app->post("/profile/change-password", function(){
	...
	if (!isset($_POST['new_pass_confirm']) || $_POST['new_pass_confirm'] === '') {
		...
		User::setError("Corfirme a nova senha.");
	...
	//caso tenha passado pelas validações anteriores, então a nova senha será alterada
